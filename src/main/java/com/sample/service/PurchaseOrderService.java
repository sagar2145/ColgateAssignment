...
@Autowired
	...
	@RequestMapping(value = "/updateall121", method = RequestMethod.POST, consumes = "application/json")
	public Response update121(@RequestBody PurchaseOrderHeader Header){
		return purchaseImpl.updateAll121(Header.getPurchaseItemList(),Header.getCurrency(), Header.getDocument_number());
	}
